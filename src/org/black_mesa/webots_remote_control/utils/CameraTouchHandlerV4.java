...
public class CameraTouchHandlerV4 {
	 ...
	 */
	private CameraTouchListenerV4 mListener;
	 ...
	 */
	public CameraTouchHandlerV4(final float xMin, final float yMin, final float xMax, final float yMax,
			final CameraTouchListenerV4 l) {
		mXMin = xMin;
		mYMin = yMin;
		mXMax = xMax;
		mYMax = yMax;
