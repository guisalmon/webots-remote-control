...
public class CameraTouchHandlerV5 {
	 ...
	 */
	private CameraTouchListenerV5 mListener;
	 ...
	 */
	public CameraTouchHandlerV5(final float xMin, final float yMin, final float xMax, final float yMax,
			final CameraTouchListenerV5 l) {
		mXMin = xMin;
		mYMin = yMin;
		mXMax = xMax;
		mYMax = yMax;
	...
	private void timerHandler() {
		...
		case SINGLE_SIDE:
			...
			mListener.turnPitch(resX, resY, time);
			mTimestamp = now;
			break;
		case DOUBLE_SIDE:
			throw new RuntimeException();
