...
public class CameraViewJoysticks extends View implements CameraJoystickCoordinateListener {
	...
	private void drawJoystick(Canvas canvas, float centerXMainCircle, float centerYMainCircle, float centerXSecondaryCircle, float centerYSecondaryCircle, float joystickRadius)
	{
		...
		canvas.drawCircle(centerXSecondaryCircle, centerYSecondaryCircle, joystickRadius / 2,
				secondaryCircle);
		// paint lines
		canvas.drawLine(centerXMainCircle, centerYMainCircle, centerXMainCircle,
				(centerYMainCircle - joystickRadius), verticalLine);
		canvas.drawLine((centerXMainCircle - joystickRadius), centerYMainCircle,
				(centerXMainCircle + joystickRadius), centerYMainCircle,
				horizontalLine);
		canvas.drawLine(centerXMainCircle, (centerYMainCircle + joystickRadius),
				centerXMainCircle, centerYMainCircle, horizontalLine);
	}
